...
### 5.4 阶段四：降级 DAG + 灾难恢复（P1）

| 任务 | 工作量(人月) | 优先级 | 说明 |
|------|-------------|--------|------|
| 降级 DAG 设计 | 0.8 | P1 | 反向拓扑排序、组件依赖分析 |
| 降级 DAG 开发 | 2.5 | P1 | DAG 编排器、反向执行逻辑 |
...
| 阶段二：PhaseFlow 回滚 | 4.5 | P0 | M2: 2027Q1 |
| 阶段三：版本回滚 + 应用备份 | 4.0 | P1 | M3: 2027Q2 |
| 阶段四：降级 DAG + 灾难恢复 | 6.0 | P1 | M4: 2027Q3 |
| **总计** | **17.5** | | |
