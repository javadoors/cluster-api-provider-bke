...
> 以下对应原方案第 2 章「优化重构方案」，包含四个子方案：三字段整合、状态转换表、改进状态管理器、事件系统。
