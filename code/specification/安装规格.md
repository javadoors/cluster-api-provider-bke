...
**位置**：[api/capbke/v1beta1/bkecluster_consts.go:151-183](file:///cluster-api-provider-bke/api/capbke/v1beta1/bkecluster_consts.go#L151-L183)
...
**位置**：[api/bkecommon/v1beta1/bkecluster_spec.go](file:///cluster-api-provider-bke/api/bkecommon/v1beta1/bkecluster_spec.go)
...
**代码位置**：
- 字段定义：[api/bkecommon/v1beta1/bkecluster_spec.go:48](file:///cluster-api-provider-bke/api/bkecommon/v1beta1/bkecluster_spec.go#L48)
- 执行逻辑：[pkg/phaseframe/phases/ensure_paused.go:59-100](file:///cluster-api-provider-bke/pkg/phaseframe/phases/ensure_paused.go#L59-L100)
...
**代码实现**（[pkg/command/env.go:149-155](file:///cluster-api-provider-bke/pkg/command/env.go#L149-L155)）：
...
**默认值设置**（[utils/capbke/annotation/helper.go:82-84](file:///cluster-api-provider-bke/utils/capbke/annotation/helper.go#L82-L84)）：
