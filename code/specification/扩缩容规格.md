...
工程中扩缩容分两条路径，由 Phase 注册顺序决定（[list.go:32-78](https://gitcode.com/openfuyao/cluster-api-provider-bke/pkg/phaseframe/phases/list.go#L32-L78)）：
...
**位置**：[utils/capbke/predicates/bkecluster.go:70](https://gitcode.com/openfuyao/cluster-api-provider-bke/utils/capbke/predicates/bkecluster.go#L70)
...
**位置**：[utils/capbke/predicates/bkecluster.go:139-159](https://gitcode.com/openfuyao/cluster-api-provider-bke/utils/capbke/predicates/bkecluster.go#L139-L159)
...
**位置**：[controllers/capbke/bkecluster_controller.go:313-317](https://gitcode.com/openfuyao/cluster-api-provider-bke/controllers/capbke/bkecluster_controller.go#L313-L317)
...
**位置**：[ensure_master_join.go:113-298](https://gitcode.com/openfuyao/cluster-api-provider-bke/pkg/phaseframe/phases/ensure_master_join.go#L113-L298)
...
**位置**：[ensure_worker_join.go:105-505](https://gitcode.com/openfuyao/cluster-api-provider-bke/pkg/phaseframe/phases/ensure_worker_join.go#L105-L505)
...
**位置**：[ensure_master_delete.go:100-340](https://gitcode.com/openfuyao/cluster-api-provider-bke/pkg/phaseframe/phases/ensure_master_delete.go#L100-L340)
...
**位置**：[ensure_worker_delete.go:413-664](https://gitcode.com/openfuyao/cluster-api-provider-bke/pkg/phaseframe/phases/ensure_worker_delete.go#L413-L664)
...
**位置**：[pkg/phaseframe/phaseutil/util.go:330-399](https://gitcode.com/openfuyao/cluster-api-provider-bke/pkg/phaseframe/phaseutil/util.go#L330-L399)
...
**Worker 扩容额外过滤**（[ensure_worker_join.go:77](https://gitcode.com/openfuyao/cluster-api-provider-bke/pkg/phaseframe/phases/ensure_worker_join.go#L77)）：
...
**排除已关联 Machine 的节点**（[ensure_master_join.go:177](https://gitcode.com/openfuyao/cluster-api-provider-bke/pkg/phaseframe/phases/ensure_master_join.go#L177)、[ensure_worker_join.go:230](https://gitcode.com/openfuyao/cluster-api-provider-bke/pkg/phaseframe/phases/ensure_worker_join.go#L230)）：
...
**位置**：[pkg/phaseframe/phaseutil/util.go:467-585](https://gitcode.com/openfuyao/cluster-api-provider-bke/pkg/phaseframe/phaseutil/util.go#L467-L585)
...
**位置**：[pkg/phaseframe/phases/common.go:60](https://gitcode.com/openfuyao/cluster-api-provider-bke/pkg/phaseframe/phases/common.go#L60)
...
**位置**：[api/capbke/v1beta1/bkecluster_consts.go:169-173](https://gitcode.com/openfuyao/cluster-api-provider-bke/api/capbke/v1beta1/bkecluster_consts.go#L169-L173)
...
**位置**：[api/bkecommon/v1beta1/bkenode_types.go:36-42](https://gitcode.com/openfuyao/cluster-api-provider-bke/api/bkecommon/v1beta1/bkenode_types.go#L36-L42)
...
**位置**：[phase_flow.go:368-445](https://gitcode.com/openfuyao/cluster-api-provider-bke/pkg/phaseframe/phases/phase_flow.go#L368-L445)
...
**触发 Phase 范围**（[list.go:116-128](https://gitcode.com/openfuyao/cluster-api-provider-bke/pkg/phaseframe/phases/list.go#L116-L128)）：
...
**位置**：[ensure_master_join.go:255-298](https://gitcode.com/openfuyao/cluster-api-provider-bke/pkg/phaseframe/phases/ensure_master_join.go#L255-L298)
...
**位置**：[ensure_worker_join.go:450-505](https://gitcode.com/openfuyao/cluster-api-provider-bke/pkg/phaseframe/phases/ensure_worker_join.go#L450-L505)
...
**位置**：[ensure_master_delete.go:165-340](https://gitcode.com/openfuyao/cluster-api-provider-bke/pkg/phaseframe/phases/ensure_master_delete.go#L165-L340)
...
**位置**：[ensure_worker_delete.go:126-664](https://gitcode.com/openfuyao/cluster-api-provider-bke/pkg/phaseframe/phases/ensure_worker_delete.go#L126-L664)
...
**位置**：[ensure_worker_join.go:383-405](https://gitcode.com/openfuyao/cluster-api-provider-bke/pkg/phaseframe/phases/ensure_worker_join.go#L383-L405)
...
**Worker 扩容结果判定**（[ensure_worker_join.go:383-405](https://gitcode.com/openfuyao/cluster-api-provider-bke/pkg/phaseframe/phases/ensure_worker_join.go#L383-L405)）：
...
**位置**：[ensure_master_delete.go:165-298](https://gitcode.com/openfuyao/cluster-api-provider-bke/pkg/phaseframe/phases/ensure_master_delete.go#L165-L298)
...
**Boot Timeout 配置**（[pkg/phaseframe/phaseutil/bkecluster.go:158](https://gitcode.com/openfuyao/cluster-api-provider-bke/pkg/phaseframe/phaseutil/bkecluster.go#L158)）：
...
**位置**：[api/capbke/v1beta1/bkecluster_types.go](https://gitcode.com/openfuyao/cluster-api-provider-bke/api/capbke/v1beta1/bkecluster_types.go)
