...
// LogInitConfig prints resolved startup configuration after process init.
// Call this from main() instead of init() to avoid triggering logger side
// effects during package initialization.
func LogInitConfig() {
